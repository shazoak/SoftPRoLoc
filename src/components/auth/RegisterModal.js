...
import {Button, Modal, ModalHeader, ModalBody, Form,Alert, FormGroup, Label, Input , NavLink} from 'reactstrap';
                    ...
                    <ModalBody>
                        ...
                        <Form onSubmit={this.onSubmit}>
                            <FormGroup>
                                ...
                                <Input className="mb-3" type="password" name="password2" id="password2" placeholder="Confirm Password" onChange={this.onChange}/>
